...
<body style="">
	...
	<div class="pic">
		<img src="<c:url value="/res/images/about/5.png"/>" style="width:100%;"/>
	</div>
	<div class="aboutDDL">
		<img src="<c:url value="/res/images/about/6.png"/>" style="width:40%;">

		<div class="ab-con">
			<div class="ab-con-text">
				<div
					style="font-size: 20px; color: rgb(79, 79, 79); text-indent: 2.1em; letter-spacing: 1px; line-height: 1.6em">
					栋栋梨教育，不仅注重学习习惯和学习能力的培养，更注重学生人格的塑造。在栋栋梨，
					每一个学生的闪光点都会得到赞扬，每一个学生的潜能都会得到发掘。</div>
				<div
					style="font-size: 24px; color: rgb(143, 194, 31); text-indent: 2em; letter-spacing: 2px; margin-top: 50px;">
					栋栋梨的教育宗旨是：
	...
	<div class="rules">
		<img src="<c:url value="/res/images/about/3.png"/>"  style="width:100%;"/> <a
			name="bbzd"><div class="title-g" style="margin-top: 50px">
				&lt;报班制度&gt;</div> </a>
		<div class="content">
	...
	<div class="question">
		<img src="<c:url value="/res/images/about/4.png"/>" style="width:100%;" /> <a
			name="qaa"><div class="title-y" style="margin-top: 50px">
				&lt;栋栋梨Q&A&gt;</div> </a>
		<div class="content">
