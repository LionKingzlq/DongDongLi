...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="<c:url value="/res/css/index.css"/>">
...
<div class="sc">
    ...
    <div class="motto" style="background: url(<c:url value="/res/images/index/2.png"/>)">
...
<div class="teacher">
    ...
    <div class="teacherIntro" style="background: url(<c:url value="/res/images/index/3.png"/>)">
...
<div class="news">
    ...
    <div class="newsTitle">
        <table class="tb" style="border-collapse:separate;border-spacing: 5px;">
            <tr>
                <td>2015-06-15</td>
...
<div class="th">
    ...
    <div class="reason">
        <img src="<c:url value="/res/images/index/9.png"/>" style="margin-left: 8px">
...
<div class="fo" style="background: url(<c:url value="/res/images/index/11.png"/>)">
    <div class="fo-fi">
