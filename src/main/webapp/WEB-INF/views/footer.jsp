...
<style>
  .footer {width:100%;height: 220px;background-color: rgb(79,79,79);margin-left: auto;margin-right: auto; clear:both;}
  .footer a{color: #ffffff;margin-left: 5px;margin-right: 5px;}
  .footer a:hover{text-decoration: none ;color: rgb(143, 194, 31)}
</style>

<div class="footer">
  <div style="position:relative;float:left;width: 70%;height: 100%; text-align: center">
    <div style="height: auto;width: 755px;height: 38px;margin-left: auto;margin-right:auto;
                margin-top: 20px;color: rgb(143, 194, 31)">
    ...
    <div style="position: relative;height: 30px;width: 780px;border: groove 0px rgb(52, 52, 52);
  ...
  <div style="float:left;width: 30%;height: 100%;">
    <div style="float:left;height: 38px;width: 121px;margin-top: 20px;color: rgb(143, 194, 31)">
      <div style="float:left;text-align: left;height: 38px;width: 121px;font-size: 24px;font-weight: 600">关注我们
      </div>
    </div>
